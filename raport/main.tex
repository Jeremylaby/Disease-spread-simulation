...
same cell. The global configuration is stored in dataclasses, which makes
the parameters of the experiment explicit and easy to change. The most
important configurable parameters are the population size, grid
dimensions, infection probability, recovery probability, incubation
period, mortality parameters, hospital capacity, vaccination
effectiveness, avoidance behavior, immunity duration, quarantine
threshold, and number of simulation steps.
...
\texttt{DataFrame}. The epidemic curve is then visualized using
Matplotlib by plotting the SEIRD state counts over time.
