...
available capacity. If recovery does not occur, the model checks whether
the agent dies. Mortality is age-dependent: all infected agents have a
base mortality probability, and an additional age-related penalty is
added for agents above the configured age threshold. This makes older
agents more vulnerable, which improves the realism of the population
model.
...
probability in future contacts. In this model, vaccination is represented
